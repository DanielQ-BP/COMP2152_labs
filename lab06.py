...
def load_previous_game():
    try:
        with open("save.txt", "r") as file:
            ...
            print("Previous game result:", last_line)
            if "Hero" in last_line and int(last_line.split()[-2]) > 3:
                return 0, 1  # Monster gets +1 strength
            elif "Monster" in last_line:
                return 1, 0  # Hero gets +1 strength
    except (FileNotFoundError, IndexError, ValueError):
        pass
    return 0, 0  # No modifications
...
if not input_invalid:
  ...
  @        ..@#% @     @&*#@(         % 
   &   (  @    (   / /   *    @  .   /  
    ...
    # Loads the previous game result
    hero_bonus, monster_bonus = load_previous_game()
    ...
    # Apply previous game bonuses
    combat_strength += hero_bonus
    m_combat_strength += monster_bonus
    ...
    if len(name) == 2 and name[0].isalpha() and name[1].isalpha():
        ...
        print("Invalid name format. Using default hero name 'Hero'.")
        short_name = "Hero"
